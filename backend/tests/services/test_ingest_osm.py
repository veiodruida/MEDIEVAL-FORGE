...
# ---------------------------------------------------------------------------
# Test 5: Client disconnect — _sse_generator finally sets stop_event
# ---------------------------------------------------------------------------

async def test_sse_generator_sets_stop_event_on_client_disconnect():
    ...
    original_run_ingest = ingest_module.run_ingest

    try:
        ingest_module.run_ingest = _fake_run_ingest  # type: ignore[assignment]
        ...
        # Consume one message from the generator
