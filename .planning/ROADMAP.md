...
**Plans:** 3 plans
Plans:
- [ ] 01-01-PLAN.md — Wave 0 preflight + scaffold (verify P-1/Q10, source ES TopoJSON, commit fixtures + inputs, move territory data, scaffold pipeline package + RegionConfig)
